...
# override weird bug in formatting when printing summaries inside R markdown
# (should be fixed soon by updates to posterior or rmarkdown packages)
...
From the posterior of `beta`, it appears increasing the number of bait stations set in a
building is associated with a lower number of complaints about cockroaches that were
